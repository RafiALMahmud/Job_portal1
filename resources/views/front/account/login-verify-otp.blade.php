        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                <div class="card shadow border-0 p-5">
                    <h1 class="h3">Two-step verification</h1>
                    <p class="text-muted">Enter the Hirely login code sent to your email.</p>

                    @include('front.account.partials.otp-alerts')

                    <form action="{{ route('account.verifyLoginOtp') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="otp" class="mb-2">Login code*</label>
                    ...
                    <form action="{{ route('account.resendLoginOtp') }}" method="POST" class="mt-3">
                        @csrf
